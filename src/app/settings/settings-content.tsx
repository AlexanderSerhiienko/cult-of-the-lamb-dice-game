  ...
  return (
    <>
      <PagePanel
        ...
        panelClassName="space-y-6 rounded-2xl border border-slate-700 bg-slate-900/70 p-6 pt-14 shadow-xl shadow-slate-950/40 md:p-8 md:pt-16"
        backHref="/"
      >
            ...
            <div className="rounded-xl border border-slate-700 bg-slate-800/60 p-4">
              <div className="flex items-center justify-between gap-3">
                ...
                <ActionButton
                  ...
                  variant={soundEnabled ? "accent" : "neutral"}
                  size="sm"
                >
                  {soundEnabled ? "On" : "Off"}
                </ActionButton>
